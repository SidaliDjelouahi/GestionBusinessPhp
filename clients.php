    ...
    <div class="sidebar-nav">
        ...
        <div class="nav-item">
            <a href="dashboard.php"
               class="nav-link-item <?= $current_page==='dashboard' ? 'active' : '' ?>"
        ...
        <div class="nav-item">
            <a href="utilisateurs.php"
               class="nav-link-item <?= $current_page==='utilisateurs' ? 'active' : '' ?>"
        ...
        <div class="nav-item">
            <a href="products.php"
               class="nav-link-item <?= $current_page==='products' ? 'active' : '' ?>"
               data-label="Produits">
        ...
        <div class="nav-item">
            <a href="achats/achats.php"
               class="nav-link-item <?= $current_page==='achats' ? 'active' : '' ?>"
               data-label="Achats">
        ...
        <div class="nav-item">
            <a href="ventes/ventes.php"
               class="nav-link-item <?= $current_page==='ventes' ? 'active' : '' ?>"
               data-label="Ventes">
        ...
        <div class="nav-item">
            <a href="clients.php"
               class="nav-link-item <?= $current_page==='clients' ? 'active' : '' ?>"
               data-label="Clients">
        ...
        <div class="nav-item">
            <a href="fournisseurs.php"
               class="nav-link-item <?= $current_page==='fournisseurs' ? 'active' : '' ?>"
               data-label="Fournisseurs">
